<%@ Page Title="" Language="C#" MasterPageFile="~/PanelAdministrativo/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="cProductores.aspx.cs" Inherits="ConectandoProductores.PanelAdministrativo.cProductores" %>
...
&nbsp;&nbsp;&nbsp;
    ...
    <asp:GridView ID="ConsultaGridView" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" Width="100%">
        ...
        <Columns>
            <asp:HyperLinkField DataNavigateUrlFields="IdProductor" DataNavigateUrlFormatString="~/PanelAdministrativo/rUsuario.aspx?Tipo=2?IdProductor={0}" HeaderText="Editar" Text="Editar" />
        </Columns>
