<%@ Page Title="" Language="C#" MasterPageFile="~/PanelAdministrativo/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="cClientes.aspx.cs" Inherits="ConectandoProductores.PanelAdministrativo.cClientes" %>
...
&nbsp;&nbsp;&nbsp;
    ...
    <asp:GridView ID="ConsultaGridView" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" Width="100%">
        ...
        <Columns>
            <asp:HyperLinkField DataNavigateUrlFields="IdCliente" DataNavigateUrlFormatString="~/PanelAdministrativo/rUsuario.aspx?Tipo=1?IdCliente={0}" HeaderText="Editar" Text="Editar" />
        </Columns>
