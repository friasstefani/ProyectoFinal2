<%@ Page Title="" Language="C#" MasterPageFile="~/PanelAdministrativo/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="cProductos.aspx.cs" Inherits="ConectandoProductores.PanelAdministrativo.cProductos" %>
...
&nbsp;
    <asp:DropDownList ID="DropDownListTipoFiltro" runat="server" Height="23px" Width="159px">
        <asp:ListItem Value="a.Descripcion" Text="Descripcion"></asp:ListItem>
    </asp:DropDownList>
&nbsp;
...
&nbsp;&nbsp;&nbsp;
    ...
    <asp:GridView ID="ConsultaGridView" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" Width="100%">
        ...
        <Columns>
            <asp:HyperLinkField DataNavigateUrlFields="IdProducto" DataNavigateUrlFormatString="~/PanelAdministrativo/rProductos.aspx?IdProducto={0}" HeaderText="Editar" Text="Editar" />
        </Columns>
